...
export const AsideMobile = () => {
  ...
  return (
    <div className="lg:hidden right-4 z-50">
      <Sheet open={open} onOpenChange={setOpen}>
        ...
        <SheetContent side="right" className="w-[300px] sm:w-[350px] overflow-y-auto p-5">
          <SheetHeader>
          ...
          <div className="flex flex-col gap-6 mt-6">
            ...
            <Button
              className="mt-4 w-full h-12 rounded-none bg-black"
