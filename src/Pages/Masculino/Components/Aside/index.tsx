...
export const Aside = () => {
  ...
  return (
    <>
      <aside className="w-[250px] hidden lg:flex flex-col gap-6">
        <div className="flex items-center gap-1">
          <p>Home</p>
          <p>{'>'}</p>
          <p className="text-black font-semibold">Masculino</p>
        </div>
        <div className="w-full h-full flex flex-col gap-6 p-6 border border-neutral-200">
